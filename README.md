...
- Global build: https://unpkg.com/animere@2.0.3/dist/animere.iife.js
  - Exposes `Animere` global property, supports auto initializing
- ESM build: https://unpkg.com/animere@2.0.3/dist/animere.es.js
...
| `axis`         | `undefined` | In some cases, you may also want to calculate the intersection based on the width or height of an element, instead of its entire size alone. Use `x` or `y` as axis values to take them into account.                                            |
